...
<head>
    ...
    <title>Brian's Place - Medio 2020 online</title>
    ...
    <div class="box">
            <header id="header" class="header clearfix">
                <div class="header-wrap clearfix">
                    ...
                    <div class="logo-mobi"> <a href="index"> <img src="images/logo2.png" alt="image" width="100px;" id="logobrian" class="logo" style="position: relative; top: 5vh;"></a></div>
                    <!--<div class="btn-menu">
                        <span></span>
                    </div>-->
                        <nav id="mainnav" class="mainnav">
                            ...
                            <li class="logo">
                                <a href="home"><img src="images/logo2.png" alt="image" width="180px;" id="logobrian" class="logo" style="position: relative; top: 5vh;"></a>
                                </li>
                               <!-- <li class="has-sub">   
                                    <a href="home">Home</a>
    ...
    <a href="https://www.instagram.com/bistro_brians_place/?hl=nl" target="_blank" ><i class="fa fa-instagram" ></i></a>
        ...
        <div class="row">
            ...
            <div class="top-section">
                     ...
                     <br/>
                    <h3>Bistro/pannenkoekenhuis Brian's Place is nog niet open.
We verwachten een opening medio 2de helft 2020.
</h3>
                    </div>
